...
;; Not sure about this stuff; seems to be for interactively sending stuff to icfb
;; For this to work it would probably require me to be running emacs on the same machine as virtuoso at least?
;; Maybe comment these out if they cause issues
